...
p1 <- data_clean %>%
  ...
  labs(x = "Year", y = "LGBT+ Rights Index", 
       ...
       subtitle = "This line graph showcases the disparity in equality for LGBT+ individuals across the globe. It highlights the diverse trajectories regions of the world have been on to improve the rights for LGBT+ people - illuminating the 
       diverse lived experiences of LGBT+ communities globally. The index measures a country's policy equality between LGBT+ and non-LGBT+ residents. Key highlights include the significant surge observed in South America over the past decade 
       reflecting the impact of cultural movements in this region. Conversely, the stagnant change in Africa underscores the ongoing challenges in this region for LGBT+ people.",
